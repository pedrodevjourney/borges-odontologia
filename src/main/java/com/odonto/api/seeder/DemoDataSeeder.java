...
public class DemoDataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        List<Paciente> pacientes = List.of(
                criarPaciente("Maria Silva", "Centro", "Rua das Flores, 123 - Centro, São Paulo - SP",
                        "Dentista", LocalDate.of(1985, 3, 15), "Brasileira", "Dr. João",
                        LocalDate.of(2025, 1, 10), "(11) 99999-1111", "(11) 3333-1111",
                        EstadoCivil.CASADO, "529.982.247-25"),

                criarPaciente("João Santos", "Jardim América", "Av. Brasil, 456 - Jardim América, São Paulo - SP",
                        "Engenheiro", LocalDate.of(1990, 7, 22), "Brasileira", "Maria Silva",
                        LocalDate.of(2025, 2, 5), "(11) 99999-2222", null,
                        EstadoCivil.SOLTEIRO, "111.444.777-35"),

                criarPaciente("Ana Oliveira", "Vila Mariana", "Rua Domingos de Morais, 789 - Vila Mariana, São Paulo - SP",
                        "Professora", LocalDate.of(1978, 11, 3), "Brasileira", null,
                        LocalDate.of(2025, 3, 12), "(11) 99999-3333", "(11) 3333-3333",
                        EstadoCivil.DIVORCIADO, null),

                criarPaciente("Carlos Pereira", "Mooca", "Rua da Mooca, 321 - Mooca, São Paulo - SP",
                        "Advogado", LocalDate.of(1995, 1, 30), "Brasileira", "Ana Oliveira",
                        LocalDate.of(2025, 4, 1), "(11) 99999-4444", null,
                        EstadoCivil.UNIAO_ESTAVEL, null),

                criarPaciente("Fernanda Costa", "Pinheiros", "Rua dos Pinheiros, 654 - Pinheiros, São Paulo - SP",
                        "Médica", LocalDate.of(1988, 5, 18), "Brasileira", "Dr. João",
                        LocalDate.of(2025, 5, 20), "(11) 99999-5555", "(11) 3333-5555",
                        EstadoCivil.CASADO, "814.657.931-13"),

                criarPaciente("Roberto Almeida", "Liberdade", "Rua Galvão Bueno, 100 - Liberdade, São Paulo - SP",
                        "Contador", LocalDate.of(1970, 9, 8), "Brasileira", null,
                        LocalDate.of(2025, 6, 15), "(11) 99999-6666", null,
                        EstadoCivil.VIUVO, null),

                criarPaciente("Juliana Martins", "Consolação", "Rua Augusta, 200 - Consolação, São Paulo - SP",
                ...
                criarPaciente("Pedro Souza", "Bela Vista", "Rua Treze de Maio, 350 - Bela Vista, São Paulo - SP",
                        "Programador", LocalDate.of(1992, 4, 10), "Brasileira", null,
                        LocalDate.of(2025, 8, 10), "(11) 99999-8888", "(11) 3333-8888",
                        EstadoCivil.CASADO, null),

                criarPaciente("Camila Rodrigues", "Santana", "Rua Voluntários da Pátria, 500 - Santana, São Paulo - SP",
                        "Enfermeira", LocalDate.of(1983, 6, 7), "Brasileira", "João Santos",
                        LocalDate.of(2025, 9, 22), "(11) 99999-9999", null,
                        EstadoCivil.DIVORCIADO, null),

                criarPaciente("Lucas Ferreira", "Tatuapé", "Rua Tuiuti, 750 - Tatuapé, São Paulo - SP",
    ...
    private Paciente criarPaciente(String nome, String residencia, String enderecoCompleto,
                                   ...
                                   String telefoneSecundario, EstadoCivil estadoCivil, String cpf) {
